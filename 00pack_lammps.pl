...
@lmp_package= ("kspace","manybody","molecule","user-meamc","user-misc","user-omp","rigid","misc","dipole","user-nnp");
...
$test=`$getdat`;
$lmp_path = "/opt/lammps"."/lmp"."_mpi"."_$test";### make date information
